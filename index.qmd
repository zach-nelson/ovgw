...
citation:
  ...
  issued: "2024-01-26"
  url: https://zach-nelson.github.io/MonitoringWellsDB/
google-scholar: true
...
Summary information about the processing, number of records dropped etc, and indicator well hydrographs for visual QA/QC are provided. The most recent OVGA depth to water import template instructions are included as an appendix. Before running the same code for the next year, update `year` in the file names for 1) [the water year on the input files and master database](#updatewy), 2) [output file name for the master database](#masterdb) and the 3) [ovga update file](#ovgaupdate). The index.qmd of this repository contains the full code to process the data and produce this document.

Complete as of 1-25-24
...
# 123311 to 19865 an order of mag reduction. date aggregation?
```
...
Examined 1-24-24 - two wells missing from this year. do a year over year comparison of staids.
